...
class AbstractPlayerTest {
  ...
  public void init() {
    ...
    this.shots1.add(new Coord(4, 3));
    this.shots1.add(new Coord(5, 3));
    this.shots1.add(new Coord(3, 1));
    this.shots1.add(new Coord(0, 4));

    this.shots2 = new ArrayList<Coord>();
    this.shots2.add(new Coord(3, 4));
    this.shots2.add(new Coord(5, 2));
    this.shots2.add(new Coord(0, 1));
    this.shots2.add(new Coord(3, 5));

    this.shots3 = new ArrayList<Coord>();
    this.shots3.add(new Coord(1, 3));
    this.shots3.add(new Coord(2, 4));
    this.shots3.add(new Coord(4, 2));
    this.shots3.add(new Coord(3, 3));

    this.shots4 = new ArrayList<Coord>();
    this.shots4.add(new Coord(3, 2));
    this.shots4.add(new Coord(0, 0));
    this.shots4.add(new Coord(4, 1));
    this.shots4.add(new Coord(5, 5));
  }
